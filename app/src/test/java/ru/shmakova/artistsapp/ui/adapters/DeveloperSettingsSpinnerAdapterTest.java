...
import ru.shmakova.artistsapp.YamblzRobolectricUnitTestRunner;
import ru.shmakova.artistsapp.ui.adapters.DeveloperSettingsSpinnerAdapter.SelectionOption;
...
public class DeveloperSettingsSpinnerAdapterTest {
    ...
    public void getView_shouldBindDataAndReturnViewWithoutConvertView() {
        ...
        for (int position = 0; position < selectionOptions.size(); position++) {
            ...
            when(layoutInflater.inflate(ru.shmakova.artistsapp.R.layout.list_developer_settings_spinner_item, container, false)).thenReturn(view);

            TextView titleTextView = mock(TextView.class);
            when(view.findViewById(ru.shmakova.artistsapp.R.id.list_developer_settings_spinner_item_title_text_view)).thenReturn(titleTextView);
    ...
    public void getDropDownView_shouldBindDataAndReturnViewWithoutConvertView() {
        ...
        for (int position = 0; position < selectionOptions.size(); position++) {
            ...
            View view = mock(View.class);
            when(layoutInflater.inflate(ru.shmakova.artistsapp.R.layout.list_developer_settings_spinner_drop_down_item, container, false)).thenReturn(view);
